...
//   links here
  ...
  return (
   ...
   <div className={`navbar fixed container mx-auto font-bold md:text-white ${headerFixed ? 'bg-purple-700 animate-none duration-0':''} z-30 secetion-container shadow-xl  `}>
